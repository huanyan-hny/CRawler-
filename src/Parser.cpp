...
namespace Crawler {
    ...
    ParserObj::ParserObj(string _s): s(_s) {};


    ParserObj ParserObj::getAttribute(string attribute) {
        string res = "";
        attribute = attribute + "=\"";
    ...
    ParserObj ParserObj::getInnerHTML() {
        int start, end;
        start = 0;
        end = (int) s.size() - 1;
    ...
    vector<ParserObj> ParserObj::extract(string path, bool isLast) {
    ...
    vector<ParserObj> ParserObj::find_by_xpath(string xpath) {
    ...
    vector<ParserObj> ParserObj::find_all(string tag, string selectors) {
        vector<ParserObj> res;
    ...
    ParserObj ParserObj::find_one(string tag, string selectors) {
